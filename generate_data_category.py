...
if __name__ == '__main__':
    ...
    df['Статус_Сиротство'] = generate_category(['дети-сироты, находящиеся на полном государственном обеспечении','дети-сироты, находящиеся под опекой',None],size_df)
    ...
    df['Статус_Студенческая_семья'] = generate_category(['оба родителя студенты','мать-одиночка, отец-одиночка','полная семья с детьми',None],size_df)
    df['Статус_Профилактика'] = generate_category(['ПДН','КДН','наркологический учет','внутренний учет','СОП','несколько категорий',None],size_df)
    df['Статус_Спорт_доп'] = generate_category(['волейбол','баскетбол','борьба национальная','футбол','гиревой спорт',
                                                'теннис','легкая атлетика','армспорт','шахматы','прочее','несколько категорий',None],size_df)
    ...
    df['Статус_учёба'] = generate_category(['Обучается','Отчислен','Академический отпуск(декрет)','Академический отпуск(служба в РА)'],size_df)
